...
output = subprocess.Popen(['trufflehog https://github.com/Spiderinattack/Devops-AWS-Jenkins.git', '/var/lib/jenkins/workspace/Trufflehog_Job'], shell=True, stdout=subprocess.PIPE).communicate()[0]
