...
#trufflehog --regex --entropy False https://github.com/Spiderinattack/Devops-AWS-Jenkins.git
 ...
 rm -f trufflehog_result.txt || true
 #pip3 install truffleHog
 #sudo chmod 777 /home/ec2-user/Jenkins/Dev/Jenkins/workspace/Python_Job/TruffleHog/Trufflehog_scan.py
 trufflehog --json https://github.com/Spiderinattack/Devops-AWS-Jenkins.git >> trufflehog_result.txt
 trufflehog --json --regex --entropy False https://github.com/Spiderinattack/Devops-AWS-Jenkins.git >> trufflehog_result.txt
